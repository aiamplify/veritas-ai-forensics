...
const AuthButton: React.FC = () => {
  ...
  if (user) {
    return (
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={signOut}
          className="px-3 py-1.5 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800 transition-all"
        >
          Sign Out
        </button>
      </div>
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white text-slate-900 font-semibold text-sm hover:bg-slate-100 transition-all shadow-lg"
    >
